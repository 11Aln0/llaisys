...
__C {
    ...
    __export void llaisysSelfAttention(llaisysTensor_t attn_val, llaisysTensor_t attn_weight, llaisysTensor_t q, llaisysTensor_t k, llaisysTensor_t v, float scale);
